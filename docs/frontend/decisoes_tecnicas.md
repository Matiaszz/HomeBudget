...
## 5. Precisão de Cálculos e Matemática Financeira (Cents Strategy)
...
Fusos horários em navegadores frequentemente causam o erro clássico de retrocesso de dias (ex: uma transação de `2026-07-17` sendo exibida na tela do cliente local como `16/07/2026` devido a diferenças de fuso horário na inicialização do construtor de data padrão do JavaScript).
